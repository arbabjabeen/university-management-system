...
public class studentfeeform extends JFrame implements ActionListener {
    ...
    studentfeeform() {
        ...
        String course[] = { "Bsc", "BA", "MBA", "MSc", "BSC", "Mcom", "MA", "B.Tech", "BBA", "BCA", "MBA", "BSSE", "BSCS" };
    ...
    if (ae.getSource() == update) {
        ...
        if (crollno.getSelectedItem() == null || crollno.getSelectedItem().trim().isEmpty()) {
        ...
        try {
            ...
            while(rs.next()) {
                String fee = rs.getString(semester.toLowerCase()); // semester must match column name (in lowercase)
            ...
            if (!feeFound) {
                labeltotal.setText("");
                JOptionPane.showMessageDialog(null, "Fee information not available for selected course and semester.");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        if (total == null || total.trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Please calculate fee before paying");
            return;
        }
